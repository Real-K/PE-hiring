# -*- coding: utf-8 -*-
"""Online Appendix, Tables A1–H2 — rebuild every table of the submitted manuscript from aggregate artifacts and check it cell by cell.

Each table is defined in ../spec/appendix_tables.json: for every cell, the numeric tokens and the artifact/ledger field
...
spec = json.load(open(os.path.join(HERE, "..", "spec", "appendix_tables.json"), encoding="utf-8"))
md = ["# Online Appendix, Tables A1–H2 — regenerated from artifacts", ""]
for tab in spec:
