# Online Appendix, Tables A1–H2 — regenerated from artifacts

**Table A1. Monthly hiring measures and the volume benchmark** — Panel A. Twelve-month window
...
**Table A1. Monthly hiring measures and the volume benchmark** — Panel B. Thirty-six-month window
...
**Table C4. Additional employment horizons and worker-flow contrasts** — Panel A. Relative employment at longer horizons
...
**Table C4. Additional employment horizons and worker-flow contrasts** — Panel B. Additional within-event contrast
...
**Table F1. Worker earnings and one-year firm outcomes** — Panel B. Firm outcomes one year after the transaction
